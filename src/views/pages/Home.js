  ...
  <Fragment>
    <div className='toastify-header'>
      <div className='title-wrapper'>
        ...
        <p className='toast-title font-weight-bold'>Welcome, {name}</p>
      </div>
    </div>
    ...
    <div className='auth-wrapper auth-v2' style={{ flexDirection: 'column' }}>
      <Row style={{ width: '100%', marginLeft: '0', marginRight: '0', display: 'flex', alignItems: 'center' }}>
        ...
        <Col xs='5' sm='5' md='5' lg='5' xl='5' style={{ position: 'absolute', right: '0px', float: 'right', display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '0' }}>
          {localStorage.getItem('jwtToken') ? "" : <RegisterForm />}
        </Col>
      </Row>
      <Row className='auth-inner m-0' style={{ overflow: 'none', height: 'auto', backgroundColor: '#242b3f' }} id='video'>
        <Col className='mt-3 mb-3' sm='12' md='12' lg='12' xl='12'>
          <Row style={{ justifyContent: 'center' }}>
            <h4 className='text-danger' style={{ marginTop: '0.5rem' }}>INTRODUCING THE FIRST-EVER </h4>
            <h4 style={{ color: '#FFFF00', marginLeft: '5px', marginTop: '0.5rem' }}> BITCOIN RETURN-MULTIPLIER OPTIONS </h4>
          </Row>
        </Col>
      ...
      <Row className='auth-inner m-0' style={{ overflow: 'none', height: 'auto' }}>
        <Col className='d-none d-flex align-items-center p-5' lg='12' md='12' sm='12'>
          <div className='w-100 align-items-center justify-content-center px-5'>
            <h4 className="font-weight-bold">Unlock the Power of Fynance</h4>
            <p className='text-dark mt-1'>Options with 3X, 6X or 9X Leverage-Return vectors</p>
            <p style={{ display: 'flex', flexDirection: 'row' }}><span className='text-danger mt-1'>Every $1 price move</span>&nbsp;<span className='text-dark mt-1'> in BTC, </span>&nbsp;<span className='text-danger mt-1'>returns</span>&nbsp;<span className='text-dark mt-1'> the option holder </span>&nbsp;<span className='text-danger mt-1'>$3, $6 or $9</span></p>
            <Row>
              <Col sm='6' md='6' lg='6' xl='6'>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Contract Size: 1BTC</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Open for Trading 24/7</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Trading Protocol <span style={{ color: 'rgb(62, 87, 171)' }}>soon to be completely decentralized</span></p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Superior Asset. Leveraged Upside, Limited Downside</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Returns are net superior to holding spot BTC</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Profit from volatility. Call and Put Options</p>
                  </Col>
                </Row>
              </Col>
              <Col sm='6' md='6' lg='6' xl='6'>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>100% Gas Free. NO gas cost</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Instant Withdrawals. There is no waiting required</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Deep Liquidity. Don't wait for the market makers!</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}><span style={{ color: 'rgb(62, 87, 171)' }}>Unique Products.</span> Proprietary Options that offer leveraged upside exposure with limited risk</p>
                  </Col>
                </Row>
                <Row style={{ margin: '10px 0px 10px 0px' }}>
                  <Col sm='auto' md='auto' lg='auto' xl='auto'>
                  ...
                  <Col>
                    <p style={{ margin: '0px' }}>Investment entry-levels considerably lower compared to buying spot BTC. Every $1 placed in an option position returns 300%, 600% or 900%, considerably more than it would if kept in spot BTC.</p>
                  </Col>
                </Row>
              </Col>
            </Row>
      ...
      <Row style={{ width: '100%', marginLeft: '0', marginRight: '0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <img src='/Graphic-Vector 1 Home Page.jpg' style={{ width: '65%' }} />
      </Row>
      <Row className='auth-inner m-0' style={{ overflow: 'none', height: 'auto' }}>
        <Col className='d-none d-flex align-items-center p-5' lg='12' md='12' sm='12'>
          <div className='w-100 align-items-center justify-content-center px-5'>
            <h4 className="font-weight-bold pt-2 pb-2">Why you should choose Fynance’s Trading Infrastructure</h4>
            <Row>
              <Col><img src='/vectors/3.png' style={{ width: '100%' }} /></Col>
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h4 className="font-weight-bold pt-1 pb-1">Privacy</h4>
                <p>We realize that in the IT driven world the most valuable asset is data which could be used against you. Fynance values your privacy and the right to not disclose your personal information.</p>
              </Col>
            </Row>
            <Row>
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h4 className="font-weight-bold pt-1 pb-1">Superior System Architecture</h4>
                <p>Fynance’s proprietary technology and global server infrastructure ensure an unmatched system performance making us the ideal choice for algorithmic and high-frequency traders as well as for retail investors.</p>
              </Col>
            ...
            <Row>
              ...
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h4 className="font-weight-bold pt-1 pb-1">Multilayer Secure Trading</h4>
                <p>Fynance utilizes the most practical and highly scalable infrastructure type, that, even during peak market activity, enables traders to trade uninterrupted.
                  Fynance combines the very best of cryptocurrency and bank-grade security standards. 100% of the assets are stored in cold offline wallets with a multi-sig, MPC and split private key structure.</p>
              </Col>
            </Row>
            <Row>
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h4 className="font-weight-bold pt-1 pb-1">Transparency in every aspect</h4>
                <p>Every bit of information is available to you. From the submission of your order to its execution - you are in total control.</p>
              </Col>
            ...
            <Row>
              ...
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h4 className="font-weight-bold pt-1 pb-1">Decentralization</h4>
                <p>Fynance is in the process of evolving its option-architecture and adjacent infrastructure into a completely decentralized protocol, where every trade will be deployed via the Ethereum blockchain.This will create a completely</p>
              </Col>
            </Row>
          </div>
        </Col>
      ...
      <Row style={{ width: '100%', marginLeft: '0', marginRight: '0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <img src='/Graphic-Vector 2 Home Page.jpg' style={{ width: '100%' }} />
      </Row>
    </div>
  )
}
